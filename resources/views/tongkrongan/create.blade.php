...
@section('title', 'Bikin Tongkrongan - WadahNgopi')
...
<div class="bg-noise flex flex-col min-h-screen relative overflow-hidden"
    ...
    <header class="sticky top-0 z-50 bg-white/80 backdrop-blur-xl border-b border-slate-100 px-6 py-4">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h1 class="text-lg font-black text-[#2C1810]">Bikin Tongkrongan</h1>
                <p class="text-[0.65rem] font-bold text-slate-400 uppercase tracking-widest">Voting cafe bareng geng lo</p>
            </div>
        </div>
    </header>
